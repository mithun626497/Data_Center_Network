...
class FatTopo(Topo):
	...
	#adding host to switch links
 	self.addLink("h1","s4",1,4)
        self.addLink("h2","s4",1,3)
        self.addLink("h3","s3",1,4)
	self.addLink("h4","s3",1,3)
        self.addLink("h5","s8",1,4)
        self.addLink("h6","s8",1,3)
	self.addLink("h7","s7",1,4)
        self.addLink("h8","s7",1,3)
        self.addLink("h9","s12",1,4)
	self.addLink("h10","s12",1,3)
        self.addLink("h11","s11",1,4)
        self.addLink("h12","s11",1,3)	
	self.addLink("h13","s16",1,4)
        self.addLink("h14","s16",1,3)
        self.addLink("h15","s15",1,4)
        self.addLink("h16","s15",1,3)
